...
public class NBTUtils {
		...
		for (Object obj : json.keySet()) {
			...
			switch (type) {
				...
				case "DoubleTag":
					...
					break;
				case "ByteArrayTag":
					tag.putByteArray(key, longArrayToByteArray((long[]) inside.get("value")));
					break;
				case "IntArrayTag":
					tag.putIntArray(key, longArrayToIntArray((long[]) inside.get("value")));
					break;
				case "LongArrayTag":
	...
	public static ListTag<?> getListTagFromJson(JSONObject json) {
		...
		switch (type) {
			...
			case "ByteArrayTag":
				for (Object obj : array) {
					listTag.addByteArray(longArrayToByteArray((long[]) obj));
				}
				break;
			case "IntArrayTag":
				for (Object obj : array) {
					listTag.addIntArray(longArrayToIntArray((long[]) obj));
				}
				break;
			case "LongArrayTag":
				for (Object obj : array) {
